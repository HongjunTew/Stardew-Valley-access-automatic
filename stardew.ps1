...
$smaPiUrl = "https://github.com/Pathoschild/SMAPI/releases/download/4.1.10/SMAPI-4.1.10-installer.zip"
...
$stardewAccessUrl = "https://github.com/stardew-access/stardew-access/releases/download/v1.7.0-beta.1/stardew-access-1.7.0-beta.1.zip"
